...
const projects = [
  {
    ...
    descriptionEs: 'Aplicación web full-stack para monitorear grasa corporal, peso y progreso físico. Registros diarios, análisis de fotos, seguimiento de comidas y feedback semanal con IA.',
    descriptionEn: 'Full-stack web app for monitoring body fat, weight, and physical progress. Daily logs, photo analysis, cheat meal tracking, and AI-powered weekly feedback.',
  ...
  },
  {
    ...
    descriptionEs: 'Herramienta que convierte libros PDF en archivos MP3 usando TTS local. Completamente offline, sin costos de API.',
    descriptionEn: 'Tool that converts PDF books into MP3 files using local TTS. Completely offline, no API costs.',
    tech: ['Python', 'PyPDF2', 'Flask', 'ffmpeg'],
    github: 'https://github.com/arndev10/PDF-A-MP3',
  },
  {
    name: 'WhatsApp Audio Transcriber',
    descriptionEs: 'Aplicación web para transcribir audios de WhatsApp a texto con Whisper AI local. 100% local, privacidad completa.',
    descriptionEn: 'Web app for transcribing WhatsApp audios to text with local Whisper AI. 100% local, complete privacy.',
